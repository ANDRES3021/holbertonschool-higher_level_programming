...
class BaseTest(unittest.TestCase):
    """En esta clase verificamos todas
    ...
    def test_save_to_file_rectangle(self):
        ...
        diccionarios = [{"id": 1, "width": 10, "height": 7, "x": 2, "y": 8}, {
    ...
    def test_load_from_file_dic(self):
        lista = [{'y': 4, 'x': 3, 'id': 5, 'width': 1, 'height': 2},
        ...
        self.assertEqual(instancias[0].__str__(),
                         "[Rectangle] (5) 3/4 - 1/2")
        self.assertEqual(instancias[1].__str__(),
                         "[Rectangle] (8) 0/0 - 6/7")
